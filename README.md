...
NOTE:
  Only three files contain the UI for the systen: index.php, sign-up.php, and dashboard.php. The remaining files only contain critical backend script for API calls and rendering.
  It should be working tho... It runs in my lappy 
